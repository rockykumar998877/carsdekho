...
enum CommonStatus: int
{
    ...
    /**
     * Get the label for the common status.
     *
     * @return string The label corresponding to the common status.
     */
    ...
    /**
     * Get the color class for the common status.
     *
     * @return string The color class corresponding to the common status.
     */
